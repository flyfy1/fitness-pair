...
const games=[...['breakout','invaders','stack','knife','bubble','fruit'].map(id=>({id:'ar-'+id,start:'#start',stop:'#stop'})),{id:'dino-run',start:'#start',stop:'#stop-camera'},{id:'dino-ar',start:'#primary',stop:'#stop'}];
