...
import {saveClip,listClips,deleteClip,updateClip} from './local-clips.js';
...
export function mountClipCard(container,clip){
 ...
 if(choice){
  ...
  voicePlayback=attachConversationPlayback(video,clip.conversation,{
   enabled:()=>selectedClip===clip&&listen.checked,
