...
export function mountConversationControls(doc,connect){
 ...
 .hopmodo-native-hud{padding-right:calc(var(--hopmodo-native-padding,0px) + 128px)!important;gap:min(12px,2vw)!important;box-sizing:border-box}
