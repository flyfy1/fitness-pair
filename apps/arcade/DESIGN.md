...
The replay flow is an Operate surface: play, review, then share or download. Recording starts with the game; show a clear on-device recording notice and live status. At completion, keep the game in view; only Share focuses the replay heading. Add the name, mark, game score, website and invitation only when generating a download. Local previews and gallery uploads retain the unbranded game view. Native file sharing and gallery publication are distinct actions.
