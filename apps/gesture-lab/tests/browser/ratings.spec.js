  ...
  await page.addInitScript(() => {
    ...
    window.Worker = class {
      ...
      postMessage(data) {
        ...
        data.bitmap.close();
        const hands = window.testHand ? [structuredClone(window.testHand)] : [];
...
test('real model public V-sign fixture produces rating 2 without a canned numeric class', async ({ page, request }) => {
  let bytes;
  ...
  await page.screenshot({ path: 'test-results/ratings-public-fixture.png', fullPage: true });
