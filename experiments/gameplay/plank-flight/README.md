...
Encouragement arrives after random groups of 2–5 completed gates, with at least
12 seconds between spoken rewards. Twelve milestone lines shuffle without repeats,
paired with six short musical styles: bright, calm, playful, grounded, airy and
celebratory. Crashing plays a descending effect, then one of six randomized
spoken endings. Music ducks under speech. Voices are disclosed as AI-generated;
all assets are bundled locally, with no API call during play.
...
Those seven legacy cues remain for countdown/start and load-failure fallback.
The additional 18 GPT-generated MP3s and six original synthesized WAV stingers live
in `public/audio/encouragement/`; see [resource generation and cadence](resources/README.md).
