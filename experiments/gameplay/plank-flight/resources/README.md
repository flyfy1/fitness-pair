...
recording. It follows the browser language until the user explicitly selects a language.
...
The arcade recorder/library and other hosted games now share the same language preference through `packages/gameplay/locale.js`.
