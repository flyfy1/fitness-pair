...
Camera games other than Motion Quest and Push-up Flight use a deliberate start: raise both hands above the shoulders for one second, then lower them. Pixel Defense practice uses large instructions at the top of the AR view. See [the tutorial prototype](docs/invaders-tutorial-prototype.md).
