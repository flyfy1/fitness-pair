...
const hosts=[
 ['motion-quest','apps/motion-quest'],['dino-run','apps/dino-run'],
 ['dino-ar','experiments/gameplay/dino-ar'],['plank-flight','experiments/gameplay/plank-flight'],['camera-start','apps/camera-start']
];
